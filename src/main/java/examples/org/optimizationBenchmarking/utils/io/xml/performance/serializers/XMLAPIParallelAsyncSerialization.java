 ...
 * serialization
 */
public class XMLAPIParallelAsyncSerialization extends SerializationMethod {
   ...
   *          the number of threads to allocate
   */
  public XMLAPIParallelAsyncSerialization(final int threads) {
    super();
  ...
  public final String toString() {
    return "XMLAPIParallelAsync-" + this.m_threads; //$NON-NLS-1$
  }
  ...
  public static final void main(final String[] args) throws Exception {
    ...
    XMLAPIParallelAsyncSerialization api;
    Random r;
    ...
    for (int threads = 1; threads <= 10; threads++) {
      api = new XMLAPIParallelAsyncSerialization(threads);
