...
public enum BibliographyXML implements IXMLFileType {
  ...
  static final String ATTR_PLACE_ORIGINAL_SPELLING = BibliographyXML.ATTR_NAME_ORIGINAL_SPELLING;
  ...
  static {
    ...
    BibliographyXML.VAL_MONTHS[EBibMonth.JANUARY.ordinal()] = "jan";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.FEBRUARY.ordinal()] = "feb";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.MARCH.ordinal()] = "mar";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.APRIL.ordinal()] = "apr";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.MAY.ordinal()] = "may";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.JUNE.ordinal()] = "jun";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.JULY.ordinal()] = "jul";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.AUGUST.ordinal()] = "aug";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.SEPTEMBER.ordinal()] = "sep";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.OCTOBER.ordinal()] = "oct";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.NOVEMBER.ordinal()] = "nov";//$NON-NLS-1$
    BibliographyXML.VAL_MONTHS[EBibMonth.DECEMBER.ordinal()] = "dec";//$NON-NLS-1$
  }
  ...
  static {
    ...
    BibliographyXML.VAL_QUARTERS[EBibQuarter.SPRING.ordinal()] = "spring";//$NON-NLS-1$
    BibliographyXML.VAL_QUARTERS[EBibQuarter.SUMMER.ordinal()] = "summer";//$NON-NLS-1$
    BibliographyXML.VAL_QUARTERS[EBibQuarter.FALL.ordinal()] = "fall";//$NON-NLS-1$
    BibliographyXML.VAL_QUARTERS[EBibQuarter.WINTER.ordinal()] = "winter";//$NON-NLS-1$
  }
  ...
  static {
    ...
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.BACHELOR_THESIS.ordinal()] = "bachelor";//$NON-NLS-1$1$
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.MASTER_THESIS.ordinal()] = "master";//$NON-NLS-1$1$
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.PHD_THESIS.ordinal()] = "phd";//$NON-NLS-1$1$
  }
