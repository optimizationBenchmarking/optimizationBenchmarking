 ...
 * via their {@link org.optimizationBenchmarking.utils.NamedObject#clone()
 * clone()} method if they have any state information that may be modified
 * outside of their
...
public class Configurable extends _ConfigRoot {
  ...
  private static final void _printObject(final Object object,
    ...
    if (object == null) {
      ps.print(TextUtils.NULL_STRING);
      return;
    }
  ...
  public static final void printlnNull(final PrintStream ps) {
    ps.println(TextUtils.NULL_STRING);
  }
