...
/** an mathematical div inline function in a XHTML document */
final class _XHTML10MathDivInline extends MathDivInline {
   ...
   *          the owning text
   */
  _XHTML10MathDivInline(final BasicMath owner) {
    super(owner);
    this.open();
  }
