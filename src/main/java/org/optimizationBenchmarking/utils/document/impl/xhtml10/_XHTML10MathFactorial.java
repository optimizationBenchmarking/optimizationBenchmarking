...
/** an mathematical factorial function in a XHTML document */
final class _XHTML10MathFactorial extends MathFactorial {
   ...
   *          the owning text
   */
  _XHTML10MathFactorial(final BasicMath owner) {
    super(owner);
    this.open();
  }
