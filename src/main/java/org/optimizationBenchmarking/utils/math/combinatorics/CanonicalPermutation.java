 ...
 */
public final class CanonicalPermutation {
  ...
  private static final int[] __blueprint(final int n) {
    ...
    blue = CanonicalPermutation.s_blueprint;
    if ((i = blue.length) < n) {
      blue2 = new int[n];
      ...
      blue = CanonicalPermutation.s_blueprint;
      if (blue.length < n) {
        CanonicalPermutation.s_blueprint = blue2;
        return blue2;
      }
    }
  ...
  public static final void makeCanonicalOne(final int[] dest,
    ...
    if (count > 0) {
      System.arraycopy(CanonicalPermutation.__blueprint(count), 0, dest,
          start, count);
    }
  }
  ...
  public static final void makeCanonicalZero(final int[] dest,
    ...
    if (copy > 0) {
      dest[start] = 0;
      if ((--copy) > 0) {
        System.arraycopy(CanonicalPermutation.__blueprint(copy), 0, dest,
            (start + 1), copy);
      }
    }
  }
  ...
  public static final void makeCanonicalOne(final int[] dest) {
    final int copy;
    copy = dest.length;
    System.arraycopy(CanonicalPermutation.__blueprint(copy), 0, dest, 0,
        copy);
  }
  ...
  public static final int[] createCanonicalOne(final int count) {
    ...
    if (count > 0) {
      blue = CanonicalPermutation.__blueprint(count);
