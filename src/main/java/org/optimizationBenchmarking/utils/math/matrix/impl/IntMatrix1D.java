...
/**
 * A two-dimensional matrix composed of {@code int} values
 */
public class IntMatrix1D extends AbstractMatrix implements IImmutable {
   ...
   *          the n
   */
  public IntMatrix1D(final int[] data, final int m, final int n) {
    super();
