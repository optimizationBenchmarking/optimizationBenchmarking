...
/**
 * A matrix backed by a one-dimensional {@code double} array.
 */
public final class DoubleMatrix1D extends AbstractMatrix
   ...
   *          the n
   */
  public DoubleMatrix1D(final double[] data, final int m, final int n) {
    super();
