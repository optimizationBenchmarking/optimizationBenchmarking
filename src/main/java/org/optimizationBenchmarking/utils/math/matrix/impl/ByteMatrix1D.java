...
/**
 * A matrix backed by a one-dimensional {@code byte} array.
 */
public final class ByteMatrix1D extends AbstractMatrix
   ...
   *          the n
   */
  public ByteMatrix1D(final byte[] data, final int m, final int n) {
    super();
