...
/** The parameter representing the overall sum of the observed samples. */
public final class Sum extends StatisticParameter {
  ...
  /** {@inheritDoc} */
  @Override
  public final StableSum createAggregate() {
    return new StableSum();
  }
