...
public class TernaryFunction extends MathematicalFunction {
  ...
  public final byte compute(final byte... x) {
    ...
    return this.compute(x[0], x[1], x[2]);
  }
  ...
  public byte compute(final byte x0, final byte x1, final byte x2) {
    ...
    r = Math.min(
        ...
        Math.max(Byte.MIN_VALUE,
            this.compute(((int) (x0)), ((int) (x1)), ((int) (x2)))));
   ...
   */
  public int compute(final int x0, final int x1, final int x2) {
    final long r;

    r = Math.min(
        Integer.MAX_VALUE,
        Math.max(Integer.MIN_VALUE,
            this.compute(((long) (x0)), ((long) (x1)), ((long) (x2)))));
