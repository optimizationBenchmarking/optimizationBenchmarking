...
final class _Compound4x4 extends QuaternaryFunction {
  ...
  public final void render(final ITextOutput out,
    ...
    this.m_result
    .render(out, new __Compound4x4ParameterRenderer(renderer));
  }
   ...
   * parameter renderer} for the {@link _Compound4x4 parameter renderer}
   * for the
   */
  private final class __Compound4x4ParameterRenderer implements
  IParameterRenderer {
    ...
    __Compound4x4ParameterRenderer(final IParameterRenderer renderer) {
      ...
      if (renderer == null) {
        throw new IllegalArgumentException( //
            "Original parameter renderer of the the {@link org.optimizationBenchmarking.utils.math.functions.IParameterRenderer parameter renderer} of the {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound4x4}, a function which returns a constant value, cannot be null."); //$NON-NLS-1$
      }
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          _Compound4x4.this.m_child1.render(out, this.m_renderer);
          return;
        }
        case 1: {
          _Compound4x4.this.m_child2.render(out, this.m_renderer);
          return;
        }
        case 2: {
          _Compound4x4.this.m_child3.render(out, this.m_renderer);
          return;
        }
        case 3: {
          _Compound4x4.this.m_child4.render(out, this.m_renderer);
          return;
        }
        default: {
          throw new IllegalArgumentException( //
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          HashUtils.hashCode(_Compound4x4.this));
    }
     ...
     */
    private final _Compound4x4 __owner() {
