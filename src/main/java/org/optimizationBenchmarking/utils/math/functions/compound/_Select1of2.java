 ...
 * 2-ary} which returns the firstof its input values.
 */
final class _Select1of2 extends BinaryFunction {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;
  /**
   * The globally shared instance of the
   * {@link org.optimizationBenchmarking.utils.math.functions.compound._Select1of2}
   * , a
   * {@link org.optimizationBenchmarking.utils.math.functions.BinaryFunction
   * 2-ary} function which returns the value of the first one of its
   * parameters
   */
  static final _Select1of2 INSTANCE = new _Select1of2();
  ...
  public final boolean equals(final Object o) {
    return (o instanceof _Select1of2);
  }
