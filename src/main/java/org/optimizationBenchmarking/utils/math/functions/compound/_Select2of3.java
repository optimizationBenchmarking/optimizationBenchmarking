 ...
 * 3-ary} which returns the secondof its input values.
 */
final class _Select2of3 extends TernaryFunction {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;
  /**
   * The globally shared instance of the
   * {@link org.optimizationBenchmarking.utils.math.functions.compound._Select2of3}
   * , a
   * {@link org.optimizationBenchmarking.utils.math.functions.TernaryFunction
   * 3-ary} function which returns the value of the second one of its
   * parameters
   */
  static final _Select2of3 INSTANCE = new _Select2of3();
  ...
  public final boolean equals(final Object o) {
    return (o instanceof _Select2of3);
  }
