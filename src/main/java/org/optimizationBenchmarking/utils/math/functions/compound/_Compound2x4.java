 ...
 * 4-ary} which is composed of 2 single functions joined with a
 * {@link org.optimizationBenchmarking.utils.math.functions.BinaryFunction
 * 2-ary} function.
 */
final class _Compound2x4 extends QuaternaryFunction {
  ...
  /**
   * Create the
   * {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound2x4}
  ...
  public final void mathRender(final IMath out,
    ...
    internalMath = new _InternalMath(out,
        new __Compound2x4ParameterRenderer(renderer));
  ...
  public final void mathRender(final ITextOutput out,
      final IParameterRenderer renderer) {
    this.m_result.mathRender(out, new __Compound2x4ParameterRenderer(
        renderer));
  }
  ...
  public final boolean equals(final Object o) {
    final _Compound2x4 other;
    if (o == this) {
      return true;
    }
    if (o instanceof _Compound2x4) {
      other = ((_Compound2x4) o);
   ...
   * parameter renderer} of the {@link _Compound2x4}.
   */
  private final class __Compound2x4ParameterRenderer extends
  _CompoundParameterRendererBase {
     ...
     */
    __Compound2x4ParameterRenderer(final IParameterRenderer renderer) {
      super();
      if (renderer == null) {
        throw new IllegalArgumentException( //
      ...
      switch (index) {
        case 0: {
          if (this.m_bracesNotNeeded
              || (_Compound2x4.this.m_child1.getPrecedencePriority() > _Compound2x4.this.m_result
                  .getPrecedencePriority())) {
            _Compound2x4.this.m_child1.mathRender(out, this.m_renderer);
          } else {
            try (final IMath braces = out.inBraces()) {
              _Compound2x4.this.m_child1.mathRender(braces,
                  this.m_renderer);
            }
          }
          return;
        ...
        case 1: {
          if (this.m_bracesNotNeeded
              || (_Compound2x4.this.m_child2.getPrecedencePriority() >= _Compound2x4.this.m_result
              .getPrecedencePriority())) {
            _Compound2x4.this.m_child2.mathRender(out, this.m_renderer);
          } else {
            try (final IMath braces = out.inBraces()) {
              _Compound2x4.this.m_child2.mathRender(braces,
                  this.m_renderer);
            }
          }
          return;
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          braces = (_Compound2x4.this.m_child1.getPrecedencePriority() <= _Compound2x4.this.m_result
              .getPrecedencePriority());
          if (braces) {
            out.append('(');
          }
        ...
        case 1: {
          braces = (_Compound2x4.this.m_child2.getPrecedencePriority() < _Compound2x4.this.m_result
              .getPrecedencePriority());
          if (braces) {
            out.append('(');
          }
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          _Compound2x4.this.hashCode());
    }

    /**
     * the internal owner getter
     *
     * @return the owning {@link _Compound2x4} instance
     */
    private final _Compound2x4 __getOwner() {
      return _Compound2x4.this;
    }

    /** {@inheritDoc} */
    @Override
    public final boolean equals(final Object o) {
      final __Compound2x4ParameterRenderer other;
      if (o == this) {
        return true;
      }
      if (o instanceof __Compound2x4ParameterRenderer) {
        other = ((__Compound2x4ParameterRenderer) o);
        return ((this.m_renderer.equals(other.m_renderer)) && (_Compound2x4.this
