...
final class _Compound3x3 extends TernaryFunction {
  ...
  public final void render(final ITextOutput out,
    ...
    this.m_result
    .render(out, new __Compound3x3ParameterRenderer(renderer));
  }
   ...
   * parameter renderer} for the {@link _Compound3x3 parameter renderer}
   * for the
   */
  private final class __Compound3x3ParameterRenderer implements
  IParameterRenderer {
    ...
    __Compound3x3ParameterRenderer(final IParameterRenderer renderer) {
      ...
      if (renderer == null) {
        throw new IllegalArgumentException( //
            "Original parameter renderer of the the {@link org.optimizationBenchmarking.utils.math.functions.IParameterRenderer parameter renderer} of the {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound3x3}, a function which returns a constant value, cannot be null."); //$NON-NLS-1$
      }
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          _Compound3x3.this.m_child1.render(out, this.m_renderer);
          return;
        }
        case 1: {
          _Compound3x3.this.m_child2.render(out, this.m_renderer);
          return;
        }
        case 2: {
          _Compound3x3.this.m_child3.render(out, this.m_renderer);
          return;
        }
        default: {
          throw new IllegalArgumentException( //
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          HashUtils.hashCode(_Compound3x3.this));
    }
     ...
     */
    private final _Compound3x3 __owner() {
