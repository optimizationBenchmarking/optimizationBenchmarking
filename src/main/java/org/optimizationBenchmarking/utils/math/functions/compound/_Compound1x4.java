...
final class _Compound1x4 extends QuaternaryFunction {
   ...
   */
  _Compound1x4(final UnaryFunction result, final QuaternaryFunction child1) {
    super();
    if (result == null) {
  ...
  public final void mathRender(final ITextOutput out,
      final IParameterRenderer renderer) {
    this.m_result.mathRender(out, new __Compound1x4ParameterRenderer(
        renderer));
  }
   ...
   */
  private final class __Compound1x4ParameterRenderer extends
      ...
      switch (index) {
        case 0: {
          braces = ((_Compound1x4.this.m_child1.getPrecedencePriority() <= _Compound1x4.this.m_result
              .getPrecedencePriority()) && (!(_Compound1x4.this.m_result instanceof Absolute)));
          if (braces) {
            out.append('(');
          }
          _Compound1x4.this.m_child1.mathRender(out, this.m_renderer);
