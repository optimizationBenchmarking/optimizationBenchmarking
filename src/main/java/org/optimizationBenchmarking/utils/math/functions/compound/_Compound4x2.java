...
final class _Compound4x2 extends BinaryFunction {
  ...
  public final void mathRender(final IMath out,
    ...
    this.m_result.mathRender(out, new __Compound4x2ParameterRenderer(
        renderer));
  }
   ...
   */
  private final class __Compound4x2ParameterRenderer extends
  AbstractParameterRenderer {
    ...
    public final void renderParameter(final int index, final IMath out) {
      switch (index) {
        case 0: {
          _Compound4x2.this.m_child1.mathRender(out, this.m_renderer);
          return;
        }
        case 1: {
          _Compound4x2.this.m_child2.mathRender(out, this.m_renderer);
          return;
        }
        case 2: {
          _Compound4x2.this.m_child3.mathRender(out, this.m_renderer);
          return;
        }
        case 3: {
          _Compound4x2.this.m_child4.mathRender(out, this.m_renderer);
          return;
        }
        default: {
