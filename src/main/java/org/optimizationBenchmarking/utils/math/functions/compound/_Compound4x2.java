 ...
 * 2-ary} which is composed of 4 single functions joined with a
...
final class _Compound4x2 extends BinaryFunction {
   ...
   *         2-ary} function which contributes to the result.
   */
  final BinaryFunction m_child4;

  /**
   * Create the
   * {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound4x2}
   ...
   */
  _Compound4x2(final QuaternaryFunction result,
      final BinaryFunction child1, final BinaryFunction child2,
      final BinaryFunction child3, final BinaryFunction child4) {
    super();
    if (result == null) {
      throw new IllegalArgumentException( //
          "Result function of {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound4x2}, a function which combines the result of 4 child {@link org.optimizationBenchmarking.utils.math.functions.BinaryFunction 2-ary} functions by using an {@link org.optimizationBenchmarking.utils.math.functions.QuaternaryFunction 4-ary} function, cannot be null."); //$NON-NLS-1$
    }
  ...
  public final byte computeAsByte(final byte x0, final byte x1) {
    return this.m_result.computeAsByte(
        ...
        this.m_child4.computeAsByte(x0, x1));
  }
  ...
  public final short computeAsShort(final short x0, final short x1) {
    return this.m_result.computeAsShort(
        ...
        this.m_child4.computeAsShort(x0, x1));
  }
  ...
  public final int computeAsInt(final int x0, final int x1) {
    return this.m_result.computeAsInt(this.m_child1.computeAsInt(x0, x1),
        ...
        this.m_child4.computeAsInt(x0, x1));
  }
  ...
  public final long computeAsLong(final long x0, final long x1) {
    return this.m_result.computeAsLong(
        ...
        this.m_child4.computeAsLong(x0, x1));
  }
  ...
  public final float computeAsFloat(final float x0, final float x1) {
    return this.m_result.computeAsFloat(
        ...
        this.m_child4.computeAsFloat(x0, x1));
  }
  ...
  public final double computeAsDouble(final double x0, final double x1) {
    return this.m_result.computeAsDouble(
        ...
        this.m_child4.computeAsDouble(x0, x1));
  }
  ...
  public final void render(final ITextOutput out,
    ...
    this.m_result
    .render(out, new __Compound4x2ParameterRenderer(renderer));
  }
  ...
  public final boolean equals(final Object o) {
    final _Compound4x2 other;
    if (o == this) {
      return true;
    }
    if (o instanceof _Compound4x2) {
      other = ((_Compound4x2) o);
   ...
   * parameter renderer} for the {@link _Compound4x2 parameter renderer}
   * for the
   */
  private final class __Compound4x2ParameterRenderer implements
  IParameterRenderer {
     ...
     */
    __Compound4x2ParameterRenderer(final IParameterRenderer renderer) {
      super();
      if (renderer == null) {
        throw new IllegalArgumentException( //
            "Original parameter renderer of the the {@link org.optimizationBenchmarking.utils.math.functions.IParameterRenderer parameter renderer} of the {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound4x2}, a function which returns a constant value, cannot be null."); //$NON-NLS-1$
      }
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          _Compound4x2.this.m_child1.render(out, this.m_renderer);
          return;
        }
        case 1: {
          _Compound4x2.this.m_child2.render(out, this.m_renderer);
          return;
        }
        case 2: {
          _Compound4x2.this.m_child3.render(out, this.m_renderer);
          return;
        }
        case 3: {
          _Compound4x2.this.m_child4.render(out, this.m_renderer);
          return;
        }
        default: {
          throw new IllegalArgumentException( //
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          HashUtils.hashCode(_Compound4x2.this));
    }
     ...
     */
    private final _Compound4x2 __owner() {
      return _Compound4x2.this;
    }

    /** {@inheritDoc} */
    @Override
    public final boolean equals(final Object o) {
      final __Compound4x2ParameterRenderer other;
      if (o == this) {
        return true;
      }
      if (o instanceof __Compound4x2ParameterRenderer) {
        other = ((__Compound4x2ParameterRenderer) o);
        return ((this.m_renderer.equals(other.m_renderer) && _Compound4x2.this
