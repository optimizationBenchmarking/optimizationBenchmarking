...
final class _Compound1x1 extends UnaryFunction {
  ...
  public final void render(final ITextOutput out,
    ...
    this.m_result
    .render(out, new __Compound1x1ParameterRenderer(renderer));
  }
   ...
   * parameter renderer} for the {@link _Compound1x1 parameter renderer}
   * for the
   */
  private final class __Compound1x1ParameterRenderer implements
  IParameterRenderer {
    ...
    __Compound1x1ParameterRenderer(final IParameterRenderer renderer) {
      ...
      if (renderer == null) {
        throw new IllegalArgumentException( //
            "Original parameter renderer of the the {@link org.optimizationBenchmarking.utils.math.functions.IParameterRenderer parameter renderer} of the {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound1x1}, a function which returns a constant value, cannot be null."); //$NON-NLS-1$
      }
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          _Compound1x1.this.m_child1.render(out, this.m_renderer);
          return;
        }
        default: {
          throw new IllegalArgumentException( //
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          HashUtils.hashCode(_Compound1x1.this));
    }
     ...
     */
    private final _Compound1x1 __owner() {
