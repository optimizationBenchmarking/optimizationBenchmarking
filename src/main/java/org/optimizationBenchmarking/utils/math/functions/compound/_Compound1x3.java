...
final class _Compound1x3 extends TernaryFunction {
  ...
  public final void mathRender(final ITextOutput out,
      final IParameterRenderer renderer) {
    this.m_result.mathRender(out, new __Compound1x3ParameterRenderer(
        renderer));
  }
   ...
   */
  private final class __Compound1x3ParameterRenderer extends
  _CompoundParameterRendererBase {
      ...
      switch (index) {
        case 0: {
          if (this.m_bracesNotNeeded
              || (_Compound1x3.this.m_child1.getPrecedencePriority() > _Compound1x3.this.m_result
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          braces = ((_Compound1x3.this.m_child1.getPrecedencePriority() <= _Compound1x3.this.m_result
              .getPrecedencePriority()) && (!(_Compound1x3.this.m_result instanceof Absolute)));
          if (braces) {
            out.append('(');
          }
          _Compound1x3.this.m_child1.mathRender(out, this.m_renderer);
