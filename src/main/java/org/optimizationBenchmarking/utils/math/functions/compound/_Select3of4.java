 ...
 * 4-ary} which returns the thirdof its input values.
 */
final class _Select3of4 extends QuaternaryFunction {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;
  /**
   * The globally shared instance of the
   * {@link org.optimizationBenchmarking.utils.math.functions.compound._Select3of4}
   * , a
   * {@link org.optimizationBenchmarking.utils.math.functions.QuaternaryFunction
   * 4-ary} function which returns the value of the third one of its
   * parameters
   */
  static final _Select3of4 INSTANCE = new _Select3of4();
  ...
  public final boolean equals(final Object o) {
    return (o instanceof _Select3of4);
  }
