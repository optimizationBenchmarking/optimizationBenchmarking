...
final class _Compound2x3 extends TernaryFunction {
  ...
  public final void render(final ITextOutput out,
    ...
    this.m_result
    .render(out, new __Compound2x3ParameterRenderer(renderer));
  }
   ...
   * parameter renderer} for the {@link _Compound2x3 parameter renderer}
   * for the
   */
  private final class __Compound2x3ParameterRenderer implements
  IParameterRenderer {
     ...
     */
    __Compound2x3ParameterRenderer(final IParameterRenderer renderer) {
      super();
      if (renderer == null) {
        throw new IllegalArgumentException( //
            "Original parameter renderer of the the {@link org.optimizationBenchmarking.utils.math.functions.IParameterRenderer parameter renderer} of the {@link org.optimizationBenchmarking.utils.math.functions.compound._Compound2x3}, a function which returns a constant value, cannot be null."); //$NON-NLS-1$
      }
    ...
    public final void renderParameter(final int index,
      ...
      switch (index) {
        case 0: {
          _Compound2x3.this.m_child1.render(out, this.m_renderer);
          return;
        }
        case 1: {
          _Compound2x3.this.m_child2.render(out, this.m_renderer);
          return;
        }
        default: {
          throw new IllegalArgumentException( //
    ...
    public final int hashCode() {
      return HashUtils.combineHashes(HashUtils.hashCode(this.m_renderer),
          HashUtils.hashCode(_Compound2x3.this));
    }
     ...
     */
    private final _Compound2x3 __owner() {
      return _Compound2x3.this;
    }

    /** {@inheritDoc} */
    @Override
    public final boolean equals(final Object o) {
      final __Compound2x3ParameterRenderer other;
      if (o == this) {
        return true;
      }
      if (o instanceof __Compound2x3ParameterRenderer) {
        other = ((__Compound2x3ParameterRenderer) o);
        return ((this.m_renderer.equals(other.m_renderer) && _Compound2x3.this
