 ...
 * {@linkplain org.optimizationBenchmarking.utils.tools.impl.process.BasicProcess#close()
 * closed} (or
 * {@linkplain org.optimizationBenchmarking.utils.tools.impl.process.BasicProcess#waitFor()
 ...
 *          the process type
 */
public interface IProcessCloser<B extends BasicProcess> {
