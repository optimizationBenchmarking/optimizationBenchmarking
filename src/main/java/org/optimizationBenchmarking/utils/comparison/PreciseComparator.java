...
public class PreciseComparator<T> implements Comparator<T> {
   ...
   *         <ol>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#SAME
   ...
   * {@code -1..1} . While the
   * {@link org.optimizationBenchmarking.utils.comparison.EComparison}
   * allow us to express that two objects are essentially not comparable,
   * the {@link java.util.Comparator} interface does not, as it only allows
   * to state that an object is &quot;less&quot; &quot;equal&quot;, or
   * &quot;greater&quot; than another one. Here, we translate the constants
   * indicating non-comparability
   * {@link org.optimizationBenchmarking.utils.comparison.EComparison#NOT_EQUAL}
   * and
   * {@link org.optimizationBenchmarking.utils.comparison.EComparison#NOT_SAME}
   * to {@code 0}.
   * 
   * @param a
   ...
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#LESS_OR_SAME}
   *         is translated to {@code -1}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#LESS_OR_EQUAL}
   *         is translated to {@code -1}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#EQUAL}
   *         is translated to {@code 0}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#SAME}
   *         is translated to {@code 0}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#GREATER_OR_EQUAL}
   *         is translated to {@code 1}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#GREATER_OR_SAME}
   *         is translated to {@code 1}</li>
   *         <li>
   *         {@link org.optimizationBenchmarking.utils.comparison.EComparison#GREATER}
   *         is translated to {@code 1}</li>
