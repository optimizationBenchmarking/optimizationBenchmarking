 ...
 * This wrapper allows us to forward all calls to a given graphics object.
 * Its {@link #onClose()} routine must be overridden to dispose that object
 * when the graphic context is released.
 * 
 * @param <GT>
