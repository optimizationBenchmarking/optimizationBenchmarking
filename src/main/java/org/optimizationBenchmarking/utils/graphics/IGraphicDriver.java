...
public interface IGraphicDriver {
   ...
   * of file which the
   * {@link org.optimizationBenchmarking.utils.graphics.Graphic} produces.</li>
   * <li>It provides a unique identifier for each graphic that can be
   * passed to the
   * {@link org.optimizationBenchmarking.utils.graphics.IGraphicListener#onGraphicClosed(GraphicID)}
   * method of the
