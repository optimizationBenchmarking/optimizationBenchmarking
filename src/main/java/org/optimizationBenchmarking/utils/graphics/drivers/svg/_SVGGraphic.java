...
/** the internal svg (graphics) */
final class _SVGGraphic extends GraphicProxy<SVGGraphics2D> {
   ...
   *          the height
   */
  _SVGGraphic(final SVGGraphics2D graphic, final GraphicID id,
  ...
  /** {@inheritDoc} */
  @Override
  protected final void closeInner(final SVGGraphics2D graphics)
      throws Throwable {
    Throwable error;
