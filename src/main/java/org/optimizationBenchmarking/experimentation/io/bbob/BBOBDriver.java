...
public class BBOBDriver extends FileIODriver<Object, ExperimentSetContext> {
  ...
  public static final void makeBBOBInstanceSet(
    ...
    for (final byte bdim : BBOBDriver.DIMENSIONS) {
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(1, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
            "-dimensional Sphere function"); //$NON-NLS-1$

        i.setFeatureValue(BBOBDriver.FEATURE_FUNCTION_ID, fidDesc,
            ints[1], null);
        fidDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_DIMENSION, dimDesc, dim, null);
        dimDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_APPROX_N_LOCAL_OPT, noptDesc,
            d1, noptUniDesc);
        noptDesc = null;
        noptUniDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_SYMMETRIC, symDesc,
            Boolean.TRUE, symDescSym);
        symDesc = null;
        symDescSym = null;

        i.setFeatureValue(BBOBDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBDriver.FEATURE_VALUE_SEPARABLE_FULLY, sepFullyDesc);
        sepFullyDesc = null;
        sepDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i1,
            condOKDesc);
        condDesc = null;
        condOKDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_OPTIMUM_ON_BOUNDARY,
            optOnBoundDesc, Boolean.FALSE, optOnBoundFalseDesc);
        optOnBoundDesc = null;
        optOnBoundFalseDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_HAS_STEPS, stepsDesc,
            Boolean.FALSE, stepsFalseDesc);
        stepsDesc = null;
        stepsFalseDesc = null;

        i.setFeatureValue(BBOBDriver.FEATURE_RUGGED, ruggedDesc,
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(2, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBDriver.FEATURE_VALUE_SEPARABLE_FULLY, sepFullyDesc);
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i1e6,
            condIllDesc);
        condIllDesc = null;
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(3, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBDriver.FEATURE_VALUE_SEPARABLE_NONE, sepNoneDesc);
        sepNoneDesc = null;
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i10,
            null);
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(4, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(5, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(6, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(7, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i100,
            null); // TODO
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(8, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBDriver.FEATURE_VALUE_SEPARABLE_PARTIALLY, sepPartiallyDesc);
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(9, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(10, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(11, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(12, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(13, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(14, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i25,
            null);// for
        // [-5,5]
        // ??
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(15, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(16, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(17, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(18, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc,
            i1000, null);// TODO
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(19, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(20, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(21, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBDriver.FEATURE_CONDITIONING, condDesc, i30,
            null);
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(22, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(23, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBDriver._makeFunctionName(24, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
  ...
  protected void doLoadPath(final ExperimentSetContext loadContext,
    ...
    try {
      BBOBDriver.makeBBOBDimensionSet(loadContext);
    } catch (final Throwable a) {
      error = ErrorUtils.aggregateError(error, a);
    }
    try {
      BBOBDriver.makeBBOBInstanceSet(loadContext);
