 ...
 * data structures}.
 */
public class BBOBInputDriver extends FileInputDriver<ExperimentSetContext> {

  /** the globally shared instance */
  public static final BBOBInputDriver INSTANCE = new BBOBInputDriver();
  ...
  public static final void makeBBOBInstanceSet(
    ...
    ints = new Integer[BBOBInputDriver.MAX_FUNCTION + 1];
    ...
    for (final byte bdim : BBOBInputDriver.DIMENSIONS) {
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(1, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
            "-dimensional Sphere function"); //$NON-NLS-1$

        i.setFeatureValue(BBOBInputDriver.FEATURE_FUNCTION_ID, fidDesc,
            ints[1], null);
        fidDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_DIMENSION, dimDesc, dim,
            null);
        dimDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_APPROX_N_LOCAL_OPT,
            noptDesc, d1, noptUniDesc);
        noptDesc = null;
        noptUniDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_SYMMETRIC, symDesc,
            Boolean.TRUE, symDescSym);
        symDesc = null;
        symDescSym = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBInputDriver.FEATURE_VALUE_SEPARABLE_FULLY, sepFullyDesc);
        sepFullyDesc = null;
        sepDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_CONDITIONING, condDesc,
            i1, condOKDesc);
        condDesc = null;
        condOKDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_OPTIMUM_ON_BOUNDARY,
            optOnBoundDesc, Boolean.FALSE, optOnBoundFalseDesc);
        optOnBoundDesc = null;
        optOnBoundFalseDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_HAS_STEPS, stepsDesc,
            Boolean.FALSE, stepsFalseDesc);
        stepsDesc = null;
        stepsFalseDesc = null;

        i.setFeatureValue(BBOBInputDriver.FEATURE_RUGGED, ruggedDesc,
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(2, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(3, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBInputDriver.FEATURE_DIMENSION, dimDesc, dim,
            null);
        i.setFeatureValue(BBOBInputDriver.FEATURE_APPROX_N_LOCAL_OPT,
            noptDesc, d10pd, noptMultiDesc);
        noptMultiDesc = null;
        i.setFeatureValue(BBOBInputDriver.FEATURE_SYMMETRIC, symDesc,
            Boolean.FALSE, symDescAsym);

        i.setFeatureValue(BBOBInputDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBInputDriver.FEATURE_VALUE_SEPARABLE_NONE, sepNoneDesc);
        sepNoneDesc = null;
        i.setFeatureValue(BBOBInputDriver.FEATURE_CONDITIONING, condDesc,
            i10, null);
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(4, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(5, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(6, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(7, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(8, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBInputDriver.FEATURE_APPROX_N_LOCAL_OPT,
            noptDesc, d, ((d == d1) ? noptUniDesc : noptMultiDesc));

        i.setFeatureValue(BBOBInputDriver.FEATURE_SYMMETRIC, symDesc,
            Boolean.FALSE, symDescAsym);

        i.setFeatureValue(BBOBInputDriver.FEATURE_SEPARABLE, sepDesc,
            BBOBInputDriver.FEATURE_VALUE_SEPARABLE_PARTIALLY,
            sepPartiallyDesc);
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(9, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(10, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(11, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(12, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(13, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(14, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(15, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(16, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(17, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(18, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(19, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(20, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
        ...
        i.setFeatureValue(BBOBInputDriver.FEATURE_APPROX_N_LOCAL_OPT,
            noptDesc, dinf, noptMultiDesc);// TODO
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(21, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(22, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(23, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
      ...
      try (final InstanceContext i = esb.createInstance()) {
        ...
        i.setName(BBOBInputDriver._makeFunctionName(24, bdim));
        i.setDescription("the " + bdim + //$NON-NLS-1$
  ...
  protected void doLoadPath(final ExperimentSetContext loadContext,
    ...
    try {
      BBOBInputDriver.makeBBOBDimensionSet(loadContext);
    } catch (final Throwable a) {
      error = ErrorUtils.aggregateError(error, a);
    }
    try {
      BBOBInputDriver.makeBBOBInstanceSet(loadContext);
