...
public abstract class Run extends DataSet<DataPoint> implements IMatrix {
   ...
   * {@link org.optimizationBenchmarking.experimentation.data.EDimensionType#isSolutionQualityMeasure()
   ...
   * <li>If dimension {@code column} represents a
   * {@link org.optimizationBenchmarking.experimentation.data.EDimensionType#isTimeMeasure()
